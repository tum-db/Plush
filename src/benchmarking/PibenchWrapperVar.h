...
class PibenchWrapperVar : public tree_api {
...
private:
    ...
    Hashtable<std::span<const std::byte>, std::span<const std::byte>,
            PartitionType::Hash> table =
                    Hashtable<std::span<const std::byte>,
                            std::span<const std::byte>, PartitionType::Hash>("/mnt/pmem0/vogel/tabletest", true);
